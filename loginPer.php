...
<head>
  ...
  <title>Login | Portal Donasi-Ku</title>
...
<?php
    ...
    if (isset($_POST['btnLogin'])) {
        $sql_login = "SELECT * FROM user WHERE status='Aktif' AND username='".$_POST['txtUser']."' AND password='".$_POST['txtpassword']."'";
        ...
        if ($jumlah_login >=1 ){
            ...
            echo "<meta http-equiv='refresh' content='0; url=v_perseorangan/index.php'>";
        }else{
            echo "<script>alert('Login Gagal')</script>";
            echo "<meta http-equiv='refresh' content='0; url=loginPer.php'>";
        }
    }
?>
